...
const Categories = () => {
    ...
    const handleDelete = ((e) => {
        ...
        context.deleteCategory(id_cate).then((res) => {
            temp = temp.filter(e => e._id != id_cate);
            setCateGo(temp);
            addNoti('Delete categories successfully', 'success', 'Notifications')
        }).catch((err) => {
            setCateGo(temp);
            addNoti('This category cannot be deleted because there is a course', 'danger', 'Notifications')
        })
    ...
    const handleUpdate = (() => {
        ...
        context.updateCategory(idUpdate, entity).then((res) => {
            ...
            addNoti('Update categories successfully', 'success', 'Notifications');
            setCateGo(temp);
        }).catch((err) => {
            setCateGo(temp);
            addNoti('This category cannot be updated because there is a course', 'danger', 'Notifications')
        })
    })
    const handleOpenAdd = (() => {
        setShowaddCate(true);
    ...
    const handleAddNewCate = (() => {
        ...
        context.createCategory({ name: newcate }).then((res) => {
            ...
            addNoti('Add categories successfully', 'success', 'Notifications');
            let tmep = CateGo;
            setCateGo([]);
            tmep.push(res);
            setCateGo(tmep);
            ...
            addNoti('Add failed', 'danger', 'Notifications')
            console.log(err);
        })
    })
